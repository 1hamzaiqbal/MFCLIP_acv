...
class SimpleTrainer(TrainerBase):
    ...
    def build_data_loader(self):
        ...
        """
        batch_size = self.cfg.DATALOADER.BS
        ...
        self.mf_loader = dm.mf_loader
        self.sub_mf_loader = dm.sub_mf_loader
        self.sub_test_loader = dm.sub_test_loader
    ...
    @torch.no_grad()
    def test(self, split=None, flag=False, num=50):
